...
public class TeacherHelper {
    ...
    public static void main(String[] args) {
        ...
        double horaAula, salarioBase, horaAtividade, descansoSemanalRemunerado, salario, notaAluno, mediaAlunos;
        ...
        while(opcao!=4) {
            ...
            switch (opcao) {
                case 1:
                    ...
                    System.out.println("Por favor informe o valor da hora-aula praticado pela instituição: ");
                ...
                case 3:
                    ...
                    switch(gerador.nextInt(7)) {
                        case 0:
                            System.out.println("Você vai aprender JAVA eventualmente!!! ");
                            break;
                        case 1:
